...
@Component({
  selector: 'app-organizacion-actas-acuerdos',
  standalone: true,
  imports: [CommonModule, FormsModule, AdminbarraComponent],
  templateUrl: './organizacion-actas-acuerdos.component.html',
  styleUrl: './organizacion-actas-acuerdos.component.css'
})
export class OrganizacionActasAcuerdosComponent implements OnInit {
  documentos: any[] = [];
