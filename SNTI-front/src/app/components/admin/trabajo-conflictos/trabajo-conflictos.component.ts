...
@Component({
  selector: 'app-trabajo-conflictos',
  standalone: true,
  imports: [CommonModule, FormsModule, AdminbarraComponent],
  templateUrl: './trabajo-conflictos.component.html',
  styleUrl: './trabajo-conflictos.component.css'
})
export class TrabajoConflictosComponent implements OnInit {
  documentos: any[] = [];
