...
@Component({
  selector: 'app-formacion-capacitacion',
  standalone: true,
  imports: [CommonModule, FormsModule, AdminbarraComponent],
  templateUrl: './formacion-capacitacion.component.html',
  styleUrl: './formacion-capacitacion.component.css'
})
export class FormacionCapacitacionComponent implements OnInit {
  documentos: any[] = [];
